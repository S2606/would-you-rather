...
/**
 * Component for answering question
 */
class AnswerQuestion extends Component{
    ...
    handleSaveAnswer = (e) => {
        ...
        const { dispatch, authedUser, users, id  } = this.props
                    ...
                    </div>
                    {
                        !answered ? (
                          <div className="question-body">
                            ...
                            <div className={selectedAnswer === 'optionOne' ? 'option option-selected' : 'option'} onClick={(e) => { this.handleChooseAnswer('optionOne')}}>{question.optionOne.text}</div>
                            <div className={selectedAnswer === 'optionTwo' ? 'option option-selected' : 'option'} onClick={(e) => { this.handleChooseAnswer('optionTwo')}}>{question.optionTwo.text}</div>
                            ...
                            <div className="question-body">
                                ...
                                <div className={answer === 'optionTwo' ? 'option-container selected': 'option-container'}>
                                    <div className="option-one">{question.optionTwo.text}</div>
                                    <div className="poll-container">
...
function mapStateToProps({authedUser, users, questions}, { match }) {
    ...
    // Fetch if user has answered question or not
